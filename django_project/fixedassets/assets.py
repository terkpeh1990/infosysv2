...
def assets(request):
    ...
    user = request.user 
    myFilter = AssetsFilter(request.GET, queryset=asset_list,request=request)
...
def reevaluation(request):
    ...
    context = {
        ...
        'heading': 'Re-Evaluated Assets',
        'pageview': 'List of Re-Evaluated Assets',
        'app_model':app_model,
        'asset_list':asset_list, 
    }
    return render(request,template,context)
