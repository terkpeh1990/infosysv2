...
class DocumentBudget(models.Model):
    ...
    total = models.DecimalField(max_digits=10, decimal_places=2,default=1.00)
    destination = models.ForeignKey(
    ...
    def save(self, *args, **kwargs):
        ...
        super(DocumentBudget, self).save(*args, **kwargs)
...
class DocumentBeneficiary(models.Model):
    ...
    def __str__(self):
        return f"{self.document_id.title} --- {self.staff} --- {self.amount}"
